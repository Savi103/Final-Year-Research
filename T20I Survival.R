...
plot(dfbetaresidual.T20I1[,2], ylab = "Remaining Overs")
plot(dfbetaresidual.T20I1[,3], ylab = "Wickets")
plot(dfbetaresidual.T20I1[,4], ylab = "Runs")
plot(dfbetaresidual.T20I1[,5], ylab = "Career SR")
...
coeff.remaining.overs = summary(coxph.fit.T20I1)$coefficients[5,1]
coeff.wickets = summary(coxph.fit.T20I1)$coefficients[6,1]
coeff.final.runs = summary(coxph.fit.T20I1)$coefficients[7,1]
coeff.strike.rate = summary(coxph.fit.T20I1)$coefficients[8,1]
...
#Return the c value
T20I.survival.est <- function(good, poor, satisfied, very.good, remain.overs, wickets, final.runs, strike.rate, baseline){
...
for(i in 1:nrow(T20I5)){
  ...
  c <- T20I.survival.est(T20I5$Good[i], T20I5$Poor[i], T20I5$Satisfied[i], T20I5$`Very Good`[i], T20I5$`Remaining Overs`[i], T20I5$Wickets[i], T20I5$`Final Runs`[i], T20I5$`Career SR`[i], T20I5$baseline.surv.y[i])
  c.vec <- c(c.vec, c)
}
